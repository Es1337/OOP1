 ...
 * - FZlozona: oblicznie wartosc f. zlozonej  a( b (x) ). Przy czym f. a jest zadana w 
 * konstruktorze a f. b podobnie jak w PreostaRozniczka.
 ...
 *
 * UWAGA: W przypadku gdy mamy kilka hierarchii wspolpracujacych ze soba, 
 * uzywamy tylko i wylacznie interfejsow (klas bazowych). To jest wazna uwaga.
 *
